...
{{
  "instructions": {{
    ...
    "output_format": "Berikan hasil Anda dalam format JSON dengan key 'interpretasi_counterexample' tanpa menambahkan penjelasan tambahan dan simbol yang tidak diperlukan.",
